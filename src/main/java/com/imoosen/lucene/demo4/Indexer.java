package com.imoosen.lucene.demo4;
...
* */
    ...
    public static void main(String[] args) throws IOException {
        String indexDir = "E://lucenen//index";// the dirctory that stores index.
        String dataDir = "E://lucene//data";//the dirctory that stores files to be indexed.
